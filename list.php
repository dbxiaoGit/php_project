    ...
    session_start();
        if(isset($_SESSION['username']) && $_SESSION['username'] != ''){
            ...
            if($username!=NULL) {
                ...
                <td>".$username."</td>
                <form action='search.php' method='POST'><td><input type='text'
                name='title' ><input type='submit' value='search'></td></form>
                <td><a href='add1.php'>添加</a></td><td><a href='logout.php'>退
                出</a></td></tr></table>";
                ...
                while ($re=mysql_fetch_object($query_result)) {
                    ...
                    </button></a><a href='delete.php?id=".$re->id."'><button>
                    Delete</button></a></td>";
                    echo "</tr>";
                }
